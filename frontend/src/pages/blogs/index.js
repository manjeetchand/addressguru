...
const Blogs = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white max-w-[2000px] w-[80%] p-6 mx-auto py-8">
              ...
              {blogs?.map((blog) => (
                ...
                >
                  ...
                  <div className="sm:w-2/3 p-6">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 mb-3 hover:text-[#FF6E04] transition-colors cursor-pointer">
                      {blog?.title}
                    </h3>
                    <p
