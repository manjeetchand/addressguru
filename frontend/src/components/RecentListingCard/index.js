...
const RecentListingCard = ({ data }) => {
  return (
    <Link
      href={`/listings/marketplace/${data?.slug}?id=${data?.id}`}
      className="block w-[180px] h-[350px] rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden flex-shrink-0"
    >
      ...
      <div className="w-full h-[200px] bg-gray-200 relative overflow-hidden">
        {data?.logo ? (
          <Image
            ...
            alt={data?.business_name || "Business"}
            fill
