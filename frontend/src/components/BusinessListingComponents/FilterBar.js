...
const FilterBar = ({
  ...
  return (
    <div className="flex items-center md:w-[920px] px-2 py-1 max-md:w-[90vh] max-md:max-w-[350px] max-md:ml-2 max-md:my-2 rounded-lg bg-[#F7F7F7]">
      ...
      >
        ...
        <button
          className="text-[13px] bg-white px-2  rounded-sm font-semibold"
          onClick={handleReset}
        >
          Clear all
        </button>
