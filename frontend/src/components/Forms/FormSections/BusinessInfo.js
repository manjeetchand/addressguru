  ...
  const generateDescription = async () => {
    ...
    for (const modelName of availableModels) {
      try {
        ...
        }". Its facilities are ${facilityNames} and services it provides are ${serviceNames}. This is for a classified website. The description must be 300 to 500 characters (not more). Be professional and attractive. Only provide the description text, nothing else. No icons, no emojis, no special characters. Use easy English with high readability.`;
