...
const categories = [
  { label: "All Ads", icon: "grid.svg", active: true },
...

  {
    ...
    icon: "electrical-appliance.svg",
  },
  { label: "Mobiles", icon: "smartphone.svg" },
  { label: "Bikes", icon: "motorcycle.svg" },
  {
    label: "Books, Sport & Hobbies",
    icon: "award.svg",
  },
  { label: "Fashion", icon: "fashion.svg" },
  { label: "Pets", icon: "pawprint.svg" },
  {
    label: "Construction",
      ...
      <div className="h-auto p-2 uppercase text-md mt-2 ">
        ...
        <div className=" mt-7 pl-2">
          <aside className="w-full  bg-white ">
            ...
            <ul className="">
              {category?.map(({ label, icon, active,name }) => (
                <li
                  key={label}
