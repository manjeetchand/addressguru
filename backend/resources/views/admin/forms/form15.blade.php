			...
			<br/>
				...
				<input type="hidden" name="only_for"><input type="hidden" name="service[]">
				<input type="hidden" name="web_link" value="no"><input type="hidden" name="video" value="no"><input type="hidden" name="payment[]"><input type="hidden" name="ifsc"><input type="hidden" name="list_by"><input type="hidden" name="pet_friend">
...
<div class="col-md-3">
          <div class="alert alert-info form-alert">
            ...
            <ul>
              <li><strong>Name</strong>: Mention name here mentioned as per the legal documents of the business. </li>
              <li><strong>Address</strong>: Mention the address mentioned as per the legal documents of the business.  </li>
