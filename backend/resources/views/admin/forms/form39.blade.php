				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Outdoor Games" @if(is_array(old('facility')) && in_array('Outdoor Games', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Outdoor Games') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Outdoor Games
								...
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Food Facilities" @if(is_array(old('facility')) && in_array('Food Facilities', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Food Facilities') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Food Facilities
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="Food Facility" value="Stay Facilities" @if(is_array(old('facility')) && in_array('Stay Facilities', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Stay Facilities') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Stay Facilities
								...
								<div class="col-md-6">
									<input type="checkbox" name="Food Facility" value="Extra curricular activities" @if(is_array(old('facility')) && in_array('Extra curricular activities', old('facility'))) checked @endif <?php 
