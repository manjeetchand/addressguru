				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="24x7 Customer Care" @if(is_array(old('service')) && in_array('24x7 Customer Care', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', '24x7 Customer Care') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> 24x7 Customer Care
								...
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Food Facilities" @if(is_array(old('service')) && in_array('Food Facilities', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Food Facilities') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Door-step	Service
