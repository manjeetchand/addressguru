					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
                           ...
                           ?>> Food
								...
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Stay" @if(is_array(old('facility')) && in_array('Stay', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Stay') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Stay
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Transportation" @if(is_array(old('facility')) && in_array('Transportation', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Transportation') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Transportation
								...
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Adventure Activities" @if(is_array(old('facility')) && in_array('Adventure Activities', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Adventure Activities') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Adventure Activities
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Sightseeing" @if(is_array(old('facility')) && in_array('Sightseeing', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Sightseeing') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Sightseeing
