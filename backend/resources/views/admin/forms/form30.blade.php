				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Complete Predictions" @if(is_array(old('service')) && in_array('Complete Predictions', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Complete Predictions') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Complete Predictions
								...
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Marriage & Compatibility" @if(is_array(old('service')) && in_array('Marriage & Compatibility', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Marriage & Compatibility') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Marriage & Compatibility
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Health Outlook" @if(is_array(old('service')) && in_array('Health Outlook', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Health Outlook') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Health Outlook
								...
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Career Forecast" @if(is_array(old('service')) && in_array('Career Forecast', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Career Forecast') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Career Forecast
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Prosperity & Wealth" @if(is_array(old('service')) && in_array('Prosperity & Wealth', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Prosperity & Wealth') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Prosperity & Wealth
								...
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Children Matters" @if(is_array(old('service')) && in_array('Children Matters', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Children Matters') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Children Matters
