			...
			<br/>
				...
				<input type="hidden" name="bedroom"><input type="hidden" name="job_category">
				...
				<input type="hidden" name="bathroom"><input type="hidden" name="religion_view"><input type="hidden" name="only_for"><input type="hidden" name="rent">
