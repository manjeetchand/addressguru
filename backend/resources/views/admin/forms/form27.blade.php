				...
				<div class="row">
					...
					<div class="col-md-6"><br/>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-4">
									<input type="checkbox" name="service[]" value="Birthday Cakes" @if(is_array(old('service')) && in_array('Birthday Cakes', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Birthday Cakes') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>>  Birthday Cakes
								...
								<div class="col-md-4">
									<input type="checkbox" name="service[]" value="Pizza" @if(is_array(old('service')) && in_array('Pizza', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Pizza') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Pizza's
								...
								<div class="col-md-4">
									<input type="checkbox" name="service[]" value="Bakery Biscuts"  @if(is_array(old('service')) && in_array('Bakery Biscuts', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Bakery Biscuts') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Bakery Biscuts
