...
<br/>
				...
				<div class="row">
					...
					<div class="col-md-6"><br/>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Mobile Accessories" @if(is_array(old('facility')) && in_array('Mobile Accessories', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Mobile Accessories') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>>  Mobile Accessories
								...
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Mobile Recharges" @if(is_array(old('facility')) && in_array('Mobile Recharges', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Mobile Recharges') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Mobile Recharges
							...
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Buying & Selling old mobiles" @if(is_array(old('facility')) && in_array('Buying & Selling old mobiles', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Buying & Selling old mobiles') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Buying & Selling old mobiles
								</div>
								<div class="col-md-6">
									<input type="checkbox" name="facility[]" value="Other Electronics Accessories" @if(is_array(old('facility')) && in_array('Other Electronics Accessories', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Other Electronics Accessories') !== false) 
                            {
                              echo 'checked';
                            }
				...
				<input type="hidden" name="course[]"><input type="hidden" name="service[]">
