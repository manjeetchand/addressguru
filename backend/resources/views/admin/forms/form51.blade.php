					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
                           ...
                           ?>> Smart Classes
								...
								<div class="col-md-4">
									<input type="checkbox" name="facility[]" value="Canteen Area" @if(is_array(old('facility')) && in_array('Canteen Area', old('facility'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->facility : '', 'Canteen Area') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Canteen Area
