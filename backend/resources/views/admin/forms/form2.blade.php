				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Computer/Laptop on Rent " @if(is_array(old('service')) && in_array('Computer/Laptop on Rent', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Computer/Laptop on Rent') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>>  Computer/Laptop on Rent 
								</div>
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Sale & Purchase of old PC" @if(is_array(old('service')) && in_array('Sale & Purchase of old PC', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Sale & Purchase of old PC') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Sale & Purchase of old PC
								</div>
								
							</div>
							<div class="row">
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Computer/Laptop Accessories" @if(is_array(old('service')) && in_array('Computer/Laptop Accessories', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Computer/Laptop Accessories') !== false) 
                            {
                              echo 'checked';
                            }
                           ?>> Computer/Laptop Accessories
								...
								<div class="col-md-6">
									<input type="checkbox" name="service[]" value="Computer/Laptop Repair Services" @if(is_array(old('service')) && in_array('Computer/Laptop Repair Services', old('service'))) checked @endif <?php 

                            if (strpos(isset($listing) ? $listing->service : '', 'Computer/Laptop Repair Services') !== false) 
                            {
                              echo 'checked';
                            }
