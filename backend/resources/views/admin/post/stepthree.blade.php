          ...
          <div id="stop">
            ...
            <div class="row">
                ...
                <div class="button-section">
                    ...
                    <span class="prev">
                        <a href="{{url('step-two', $id)}}" class="btn">Previous Step
      ...
      <br/><br/>
        ...
        <div class="col-md-3">
          <div class="alert alert-info form-alert">
            <ul>
              <li><strong>Full Name</strong>: Mention the full name of the person to contact for business.  </li>
              <li><strong>Email</strong>: Mention the email address of your business  </li>
              <li><strong>State</strong>: Mention the state where your business is located.  </li>
              <li><strong>City</strong>: Mention the city where your business is located.   </li>
              <li><strong>Locality</strong>: Mention the locality where your business is located.   </li>
              <li><strong>Mobile Number</strong>: Mention the contact number   </li>
              <li><strong>Mobile Number (Optional)</strong>: Mention additional contact number   </li>
            </ul>
          </div>
        </div>
    </div>
