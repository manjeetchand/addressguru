...
<title>{{$listing->business_name}} | Address Guru</title>
...
<div class="container-fluid header_post">
	<div class="row">
		<div class="col-md-12 text-center ad" style="color:white;">
            ...
            <i class="{{($listing->subcategory_id == null) ? $listing->category->icon : $listing->category->icon}}"></i> {{($listing->subcategory_id == null) ? $listing->category->name : $listing->category->name.' - '.$listing->subcategory->name}}
   ...
   <!--Wizard Container-->
    ...
    <div class="row form-new">  
        <div class="col-md-9">
          ...
          {!! Form::model($listing, ['action'=>['CoachingInsert@update', $id], 'method'=>'PATCH']) !!}
          <?php
