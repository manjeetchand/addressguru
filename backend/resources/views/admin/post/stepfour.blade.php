                ...
                <div class="button-section">
                    <span class="next">
                      <button class="btn">Next Step
                            <small>Upload Slider Images</small>
                      </button>
                    </span>
                    <span class="prev">
                        <a href="{{url('step-three', $id)}}" class="btn">Previous Step
      ...
      <br/><br/>
         ...
         <div class="col-md-3">
          <div class="alert alert-info form-alert">
            <ul>
              <li><strong>Short Description of Business</strong>: Short description of your business' nature.  </li>
              <li><strong>Keywords</strong>: Mention the relevant keywords of your business  </li>
            </ul>
          </div>
        </div> 
    </div>
