...
@endif
      ...
      <div class="alert alert-success">
        <h3 class="h21">{{$listing->business_name}}</h3><br/>
        <p><strong>Thank you for listing with us.</strong> <br/>
        @if(Auth::user()->role->name == "Agent")
        The listing has been submitted, Please verify customers account to send listing for review. Listing will be made live within 24 hours after verification. If you have any queries, let us know at <a href="mailto:contact@addressguru.sg">contact@addressguru.sg</a>
        @else
        ...
        @endif<br/><br/>
        <center><a href="{{url('/preview', $listing->slug)}}" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-file fa-fw"></i> Generate Preview </a></center>
      </p>
      </div>
