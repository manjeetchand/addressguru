    ...
    {{--	<?php $i = 1; ?>
      ...
      <tr>
        ...
        <td>
            ...
            <a href="{{route('category.form',['category_id'=>$category->id,'id'=>1])}}" class="btn btn-primary btn-sm  pull-left" style="margin-right:10px;"><i class="fa fa-plus fa-fw"></i> Add Form</a>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Add Form Column</h4>
      </div>
      <div class="modal-body">
        {!! Form::open(['method'=>'POST', 'action'=>'CategoryForm@store']) !!}
          <div class="form-group">
            <label>Column Name</label>
            <input type="text" name="name" placeholder=" Enter Column Name" class="form-control" required="required" value="{{old('name')}}">
