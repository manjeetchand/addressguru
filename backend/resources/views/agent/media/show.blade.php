...
<a href="{{url('agent/listing/'.$id)}}" style="font-size:20px;"><i class="fa fa-arrow-left"></i></a><br/>
    	...
    	@foreach($photo as $photos)
   		<tr>
   			...
   			<td>
   				...
   				<!-- <a href="{{route('agent.media.edit', $photos->id)}}" class="btn btn-success pull-left"><i class="fa fa-edit"></i></a> -->

   				{!! Form::open(['method'=>'DELETE', 'action'=>['PartnerMedia@destroy', $photos->id]]) !!}
    ...
    $uploadCrop.croppie('result', {
        ...
        $.ajax({
            ...
            success: function (data) {
              window.location.href = "/agent/media/<?php  echo $id; ?>";
            }
        });
    });
});
