...
@section('content')
<h2>Packages</h2><br/>
 {!! Form::open(['action'=>'AgentPack@store']) !!}
 ...
 <table class="table table-striped table-bordered">
    ...
    @foreach($pack as $packs)
      ...
      <tr>
        ...
        <td>{{$packs->dates}}</td>
        <td>
          <a href="{{route('agent.package.edit', $packs->id)}}" class="btn btn-success pull-left"><i class="fa fa-edit"></i></a>
            {!! Form::open(['action'=>['AgentPack@destroy', $packs->id], 'method'=>'DELETE']) !!}
