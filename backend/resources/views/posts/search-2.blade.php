                            ...
                            <div class="col-8 py-1" style="padding-left:0;">
                              @if($value[0]->category->id == 52)
                                <a href="{{url('/profiles', $value[0]->slug)}}" class="search-heading">
                                  <h6 class="fw-bold text-dark mb-1" style="font-size: 14px">{{$value->name}}</h6>
                                </a>
                              @else
                                <a href="{{url('/', $value[0]->slug)}}" class="search-heading">
                                  @php
                                  $businessName = $value[0]->name;
                                  @endphp
                                  <h6 class="fw-bold text-dark mb-1" style="font-size: 14px">{{$businessName}}</h6>
                                </a>
                              @endif
