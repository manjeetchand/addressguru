...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('Dashboard.index')}}" style="font-size:30px;text-align:center;"><b>Address Guru</b></a>
        </div>
        <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="{{route('user-post.index')}}"><i class="fa fa-edit fa-fw"></i> Listings</a>
                    </li>
                     <li>
                        <a href="{{url('user-product')}}"><i class="fa fa-product-hunt fa-fw"></i>Products</a>
                    </li>
                    <li>
                        <a href="{{route('user-banner.index')}}"><i class="fa fa-edit fa-fw"></i>Banner Ad</a>
                    </li>
                     <li>
