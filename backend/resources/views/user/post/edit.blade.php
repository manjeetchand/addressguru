...
{!! Form::model($post, ['method'=>'PATCH', 'action'=>['UserPost@update', $post->id]]) !!}
				<div class="row">
			...
			@if($post->category->id == 52)
				...
				<div class="row{{ $errors->has('ad_description') ? ' has-error' : '' }}">
					<div class="col-md-12">
						...
						<textarea class="form-control" rows="6" placeholder="Type here..." name="ad_description">{{ $post->ad_description }}</textarea>
