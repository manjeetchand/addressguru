    ...
    @foreach($post as $posts)
      ...
      <tr>
        ...
        <td class="text-center">
          ...
          <a href="{{url('packcreate', $id)}}" style="font-size:20px;"><i class="fa fa-plus"></i></a>
          <br/>Add Packages
            @else
            not eligible
          @endif
        ...
        <td style="width:200px;">
          ...
          {!! Form::open(['method'=>'DELETE', 'action'=>['UserPost@destroy', $id], 'onsubmit'=>'return confirm("Are you sure?");']) !!}
