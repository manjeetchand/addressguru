...
@section('content')
<br/>
<a href="{{route('user.media.show', $photo->post_id)}}" style="font-size:20px;"><i class="fa fa-arrow-left"></i></a>
	<h1>Edit</h1><br/>
...
<hr/>
	{!! Form::model($photo, ['method'=>'PATCH', 'files'=>true, 'action'=>['UserMedia@update', $photo->id]]) !!}
		<div class="row">
			<div class="col-md-12">
