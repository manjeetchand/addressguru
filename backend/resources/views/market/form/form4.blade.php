					...
					<div class="{{ $errors->has('condition') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							...
							<select class="form-control" name="only_for" required="required">
								...
								<option value="Women Shoes & Heels">Women Shoes & Heels</option>
								<option value="Men Shoes">Men Shoes</option>
								<option value="Women's Bags">Women's Bags</option>
								<option value="Men's Bags & Accessories">Men's Bags & Accessories</option>
								<option value="Watches">Watches</option>
								<option value="Women's Accessories">Women's Accessories</option>
								<option value="Men's Clothings">Men's Clothing</option>
