				...
				<input type="hidden" name="available"><input type="hidden" name="cc"><input type="hidden" name="fuel_type"><input type="hidden" name="year"><input type="hidden" name="km"><input type="hidden" name="trans"><input type="hidden" name="color"><input type="hidden" name="condition"><input type="hidden" name="only_for"><input type="hidden" name="job_type"><input type="hidden" name="company_name"><input type="hidden" name="company_website"><input type="hidden" name="ea_number"><input type="hidden" name="share"><input type="hidden" name="dwelling"><input type="hidden" name="size"><input type="hidden" name="bedroom"><input type="hidden" name="bathroom"><input type="hidden" name="smoking"><input type="hidden" name="pet"><input type="hidden" name="gender"><input type="hidden" name="cea">
	...
	@section('right_col')
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		<li><strong>Education level</strong>: Mention your highest education qualification you have as per the legal documents issued by the reputed institution.</li>
              		<li><strong>Ad Title</strong>: Mention the Job title you want to applied for.</li>
              		<li><strong>Ad Description</strong>: Mention your skills, qualification, work experience and job title you want to applied for.</li>
