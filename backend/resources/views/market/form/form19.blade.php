				...
				<div class="row">
					...
					<div class="{{ $errors->has('cea') ? ' has-error' : '' }}">
						<div class="col-md-6">
				...
				<input type="hidden" name="pro_by"><input type="hidden" name="share"><input type="hidden" name="dwelling"><input type="hidden" name="bedroom"><input type="hidden" name="bathroom"><input type="hidden" name="smoking"><input type="hidden" name="pet"><input type="hidden" name="gender">
	...
	@section('right_col')
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		<li><strong>Available</strong>: Mention your Institutes's name here mentioned as per the legal documents of the business.</li>
              		<li><strong>Size (sqft)</strong>: Mention the address of your business' location.to be mentioned as per the legal documents of the business.</li>
