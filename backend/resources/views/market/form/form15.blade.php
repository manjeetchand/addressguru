				...
				<input type="hidden" name="model"><input type="hidden" name="dob">
				...
				<input type="hidden" name="share"><input type="hidden" name="pet"><input type="hidden" name="gender"><input type="hidden" name="smoking">
		...
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		...
              		<li><strong>CEA Number</strong>: Mention the address of your business' location.to be mentioned as per the legal documents of the business.</li>
