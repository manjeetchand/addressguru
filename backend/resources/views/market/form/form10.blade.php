					...
					<div class="{{ $errors->has('condition') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							...
							<select class="form-control" name="only_for" required="required">
								...
								<option value="Samsung Mobile Phones">Samsung Mobile Phones</option>
								<option value="ASUS Mobile Phones">ASUS Mobile Phones</option>
								<option value="Blackberry Mobile Phones">Blackberry Mobile Phones</option>
								<option value="HTC Mobile Phones">HTC Mobile Phones</option>
								<option value="Huawei Mobile Phones">Huawei Mobile Phones</option>
								<option value="LG Mobile Phones">LG Mobile Phones</option>
								<option value="Motorola Mobile Phones">Motorola Mobile Phones</option>
								<option value="Nokia Mobile Phones">Nokia Mobile Phones</option>
								<option value="Oppo Mobile Phones">Oppo Mobile Phones</option>
								<option value="Sony Mobile Phones">Sony Mobile Phones</option>
								<option value="Xiaomi Mobile Phones">Xiaomi Mobile Phones</option>
								<option value="ZTE Mobile Phones">ZTE Mobile Phones</option>
								<option value="Other Mobile Phones">Other Mobile Phones</option>
								<option value="Screen Protectors">Screen Protectors</option>
								<option value="Cases & Cover">Cases & Cover</option>
								<option value="Accessories">Accessories</option>
								<option value="Power & Cables">Power & Cables</option>
								<option value="Other Phone Items">Other Phone Items</option>
							</select>
					...
					<div class="{{ $errors->has('model') ? ' has-error' : '' }}">
						<div class="col-md-12">
							<label>Model<span>*</span></label>
								<input type="text" name="model" placeholder="Model" class="form-control" value="{{ isset($listing) ? $listing->model : old('model') }}" required="required">
							@if ($errors->has('model'))
                         	   <span class="help-block">
				...
				<input type="hidden" name="pro_by"><input type="hidden" name="dob"><input type="hidden" name="parking">
		...
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		...
              		<li><strong>Model</strong>: Mention the address of your business' location.to be mentioned as per the legal documents of the business.</li>
