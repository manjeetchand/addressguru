				...
				<input type="hidden" name="only_for"><input type="hidden" name="model"><input type="hidden" name="pro_by"><input type="hidden" name="dob">
	...
	@section('right_col')
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		<li><strong>Condition</strong>: Mention the condition of the product if it is new or used.</li>
              		<li><strong>Ad Title</strong>: Mention the product’s name</li>
              		<li><strong>Ad Description</strong>: Describe your product like specifications, colour, date of manufacturing, etc </li>             
