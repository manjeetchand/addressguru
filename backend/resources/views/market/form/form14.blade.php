				...
				<div class="row">
					<div class="{{ $errors->has('pro_by') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<label>Share Basis<span>*</span></label>
							<select class="form-control" name="share" required="required">
								<option value="{{ isset($listing) ? $listing->share : '' }}">{{ isset($listing) ? $listing->share : 'Select Share Basis' }}</option>
								<option value="Room Share">Room Share</option>
								<option value="Flat or House Share">Flat or House Share</option>
				...
				<div class="row">
					<div class="{{ $errors->has('available') ? ' has-error' : '' }}">
						<div class="col-md-6">
							...
							<input type="date" name="available" min="{{Date('Y-m-d')}}" class="form-control" required="required" value="{{ isset($listing) ? $listing->available : old('available') }}" style="min-height:50px;">
				...
				<div class="row">
					<div class="{{ $errors->has('size') ? ' has-error' : '' }}">
						<div class="col-md-6">
							...
							<input type="number" name="size" class="form-control" required="required" value="{{ isset($listing) ? $listing->size : old('size') }}" placeholder="Size (sqft)">
							@if ($errors->has('size'))
                         	   <span class="help-block">
				...
				<div class="row">
					<div class="{{ $errors->has('pet') ? ' has-error' : '' }}">
						...
						<div class="col-md-4">
							<label>Preferred Gender<span>*</span></label>
							<select class="form-control" name="gender" required="required">
								<option value="{{ isset($listing) ? $listing->gender : '' }}">{{ isset($listing) ? $listing->gender : 'Select Preferred Gender' }}</option>
				...
				<input type="hidden" name="model"><input type="hidden" name="dob"><input type="hidden" name="parking">
		...
		<div class="col-md-3">
          	<div class="alert alert-info form-alert">
            	...
            	<ul>
              		...
              		<li><strong>Share Basis</strong>: Mention the address of your business' location.to be mentioned as per the legal documents of the business.</li>
              		<li><strong>Available</strong>: Describe your business, what is serves, its motto, establishment date, industry, its.products dealing in.</li>             
              		...
              		<li><strong>Preferred Gender</strong>: Describe your business, what is serves, its motto, establishment date, industry, its.products dealing in.</li>             
