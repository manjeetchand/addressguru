...
.banner-sec .search form input[type="text"] {
    width: 67%;
    border-top-right-radius: 15px !important;
    border-bottom-right-radius: 15px !important;
}

.banner-sec .search form select {
    width: 33%;
}

.banner-sec .search form span.bi {
    top: 50%;
    right: 8px;
    width: 28px;
    height: 28px;
...
.banner-sec .r-sec .txt span:first-child {
    font-size: 3rem;
    font-family: 'Archivo Black', sans-serif;
}

.banner-sec .r-sec .txt span:last-child {
    font-size: 1.1rem;
    font-weight: 600;
    letter-spacing: 2px;
}
                ...
                <div class="card-body p-0">
                    <div class="mobile-screen px-3">
                        ...
                        <div class="desktop-screen">
                            <div class="my-4">
                            <div class="w-100 banner-sec">
                                <div class="container-xxl">
                                    <div class="row">
                                        <div class="col-7">
                                            <div class="search h-100 d-flex flex-column justify-content-between">
                                                <form action="{{route('search.store')}}" class="m-0" method="POST">
                                                    @csrf
                                                    <div class="input-group position-relative">
                                                        <select class="form-select ctydd" id="cityDropdown" data-live-search="true" name="city">
                                                        ...
                                                        <input type="text" class="form-control" value="Taxi service in Singapore" name="namebyname">
                                                        <a type="submit">
                                                         <span class="bi bi-search position-absolute d-flex align-items-center justify-content-center text-white"></span>
                                                        </a>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="col-5">
                                            <div class="r-sec d-flex align-items-center justify-content-between">
                                                <img src="{{ asset('assets/img/banner_modal.png') }}" alt="banner modal" class="pt-4">
                                                <span class="txt d-block text-white text-center">
                                                    <span>1.5 LAKH +</span>
                                                    <br>
                                                    <span class="text-uppercase">Registered Businesess</span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window.addEventListener("scroll", function () {
            if (window.scrollY > 100) { // Change 100 to the desired scroll position
                headerForm.style.display = "block"; // Show when scrolled
            } else {
                headerForm.style.display = "none"; // Hide when at the top
            }
        });
    });
</script>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var cityDropdowns = document.querySelectorAll(".ctydd");

            cityDropdowns.forEach(function (dropdown) {
                dropdown.addEventListener("change", function () {
                    var selectedValue = this.value;

                    cityDropdowns.forEach(function (otherDropdown) {
    ...
    document.querySelectorAll('.category-link').forEach(function (link) {
        link.addEventListener('click', function (e) {
            var selectedCity = "";
            document.querySelectorAll('.ctydd').forEach(function (dropdown) {
                if (dropdown.value) {
                    selectedCity = dropdown.value; // Get selected value from any dropdown
                }
            });
            ...
            if (selectedCity === "") {
                ...
                var categoryName = link.getAttribute('data-category').toLowerCase().replace(/\s+/g, '-'); 
