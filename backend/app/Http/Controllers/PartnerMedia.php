...
class PartnerMedia extends Controller
{
    /**
    ...
    public function show($id)
    {
        ...
        $photo = Media::where('post_id', '=', $new)->get();

        return view('agent.media.show', compact('post', 'photo'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('agent.media.edit', compact('photo'));
    }
